...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, router, flashMessagesServie) {
        this.authService = authService;
        this.router = router;
        this.flashMessagesServie = flashMessagesServie;
    }
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessagesServie.show('You Are Loggedin', {
                    cssClass: 'alert-success', timeout: 1000
                });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.flashMessagesServie.show(data.msg, {
...
// module
exports.push([module.i, ".ul-prop > li{\r\n    margin-left: 10px;\r\n    margin-left: 10px;\r\n    text-transform: uppercase;\r\n}\r\na {\r\n    color: #fff;\r\n    text-decoration: none;\r\n    font-size: 11px;\r\n}\r\nnavbar-dark .navbar-nav .nav-link {\r\n    color: #fff;\r\n}", ""]);
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark bg-primary\">\n  <a class=\"navbar-brand\" href=\"#\">Navbar</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarColor01\" aria-controls=\"navbarColor01\"\n    aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n\n  <div class=\"collapse navbar-collapse\" id=\"navbarColor01\">\n    <ul class=\"nav navbar-nav mr-auto\">\n      <li class=\" li-prop nav-item active\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/']\">Home\n          <span class=\"sr-only\">(current)</span>\n        </a>\n      </li>\n    </ul>\n    <ul class=\"ul-prop nav navbar-nav ml-auto\">\n      <li *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n        <a [routerLink]=\"['/dashboard']\" margin=\"1px\">Dashboard</a>\n      </li>\n      <li *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n        <a [routerLink]=\"['/profile']\" margin=\"1px\">Profile</a>\n      </li>\n      <li *ngIf=\"!authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n        <a [routerLink]=\"['/login']\" margin=\"1px\">Login</a>\n      </li>\n      <li *ngIf=\"!authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n        <a [routerLink]=\"['/register']\" margin=\"1px\">Register</a>\n      </li>\n      <li *ngIf=\"authService.loggedIn()\">\n        <a (click)='onLogoutClick()' href=\"#\">Logout</a>\n      </li>\n\n    </ul>\n  </div>\n</nav>"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService, router, flashMessagesServie) {
        this.authService = authService;
        this.router = router;
        this.flashMessagesServie = flashMessagesServie;
    }
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('Registeration Success', { cssClass: 'alert-success', timeout: 1000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessagesService.show('Woops Something Gone Wrong', { cssClass: 'alert-danger', timeout: 1000 });
